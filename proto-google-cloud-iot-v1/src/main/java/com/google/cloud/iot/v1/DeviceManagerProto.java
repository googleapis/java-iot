  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "y.proto\032\032google/iam/v1/policy.proto\032\033google/protobuf/empty.proto\032"
          + " google/protobuf/field_mask.proto\032\027google/rpc/status.proto\"\233\001\n"
          + "\033CreateDeviceRegistryRequest\0229\n"
          + "\006parent\030\001 \001(\tB)\340A\002\372A#\n"
          + "!locations.googleapis.com/Location\022A\n"
          + "\017device_registry\030\002"
          + " \001(\0132#.google.cloud.iot.v1.DeviceRegistryB\003\340A\002\"R\n"
          ...
          + "\033UpdateDeviceRegistryRequest\022A\n"
          + "\017device_registry\030\001"
          + " \001(\0132#.google.cloud.iot.v1.DeviceRegistryB\003\340A\002\0224\n"
          ...
          + "\023CreateDeviceRequest\0228\n"
          + "\006parent\030\001 \001(\tB(\340A\002\372A\"\n"
          + " cloudiot.googleapis.com/Registry\0220\n"
          + "\006device\030\002 \001(\0132\033.google.cloud.iot.v1.DeviceB\003\340A\002\"x\n"
          ...
          + "field_mask\030\004 \001(\0132\032.google.protobuf.FieldMask\022E\n"
          + "\024gateway_list_options\030\006"
          + " \001(\0132\'.google.cloud.iot.v1.GatewayListOptions\022\021\n"
          ...
          + "\007devices\030\001 \003(\0132\033.google.cloud.iot.v1.Device\022\027\n"
          + "\017next_page_token\030\002 \001(\t\"\215\001\n"
          + " ModifyCloudToDeviceConfigRequest\0224\n"
          + "\004name\030\001 \001(\tB&\340A\002\372A \n"
          ...
          + "\037ListDeviceConfigVersionsRequest\0224\n"
          + "\004name\030\001 \001(\tB&\340A\002\372A \n"
          ...
          + "device_states\030\001 \003(\0132 .google.cloud.iot.v1.DeviceState\"\177\n"
          + "\032SendCommandToDeviceRequest\0224\n"
          + "\004name\030\001 \001(\tB&\340A\002\372A \n"
          + "\036cloudiot.googleapis.com/Device\022\030\n"
          + "\013binary_data\030\002 \001(\014B\003\340A\002\022\021\n"
          + "\tsubfolder\030\003 \001(\t\"\035\n"
          + "\033SendCommandToDeviceResponse\"\207\001\n"
          ...
          + "\036UnbindDeviceFromGatewayRequest\0228\n"
          + "\006parent\030\001 \001(\tB(\340A\002\372A\"\n"
          + " cloudiot.googleapis.com/Registry\022\027\n\n"
          + "gateway_id\030\002 \001(\tB\003\340A\002\022\026\n"
          + "\tdevice_id\030\003 \001(\tB\003\340A\002\"!\n"
          + "\037UnbindDeviceFromGatewayResponse2\246&\n\r"
          + "DeviceManager\022\317\001\n"
          + "\024CreateDeviceRegistry\0220.google.cloud.iot.v1.Cr"
          + "eateDeviceRegistryRequest\032#.google.cloud.iot.v1.DeviceRegistry\"`\202\323\344\223\002A\"./v1/{parent=projects/*/locations/*}/registries:\017device_registry\332A\026parent,device_registry\022\246\001\n"
          + "\021GetDeviceRegistry\022-.google.cloud.iot.v1.GetDeviceRegistryRequest\032#.google.cloud.iot.v1.DeviceRegistry\"=\202\323\344\223\0020\022./v1/{name=projects/*/locations/*/registries/*}\332A\004name\022\344\001\n"
          + "\024UpdateDeviceRegistry\0220.google.cloud.iot.v1.UpdateDeviceRegistryReq"
          + "uest\032#.google.cloud.iot.v1.DeviceRegistry\"u\202\323\344\223\002Q2>/v1/{device_registry.name=projects/*/locations/*/registries/*}:\017device_registry\332A\033device_registry,update_mask\022\237\001\n"
          + "\024DeleteDeviceRegistry\0220.google.cloud.iot.v1.DeleteDeviceRegistryRequest\032\026.google.protobuf.Empty\"=\202\323\344\223\0020*./v1/{name=projects/*/locations/*/registries/*}\332A\004name\022\274\001\n"
          + "\024ListDeviceRegistries\0220.google.cloud.iot.v1.ListDeviceRegistriesRequest\0321.google.cloud.iot.v1.ListDeviceRegistriesResponse\"?\202\323\344\223\0020\022./v1/{parent=projects/*/locations/*}/registries\332A\006parent\022\257\001\n"
          + "\014CreateDevice\022(.google.cloud.iot.v1.CreateDeviceRequest\032\033.google.cloud.iot.v1.Device\"X\202\323\344\223\002B\"8/v1/{parent=projects/*/locations/*/registries/*}/devices:\006device\332A\r"
          + "parent,device\022\336\001\n"
          + "\tGetDevice\022%.google.cloud.iot.v1.GetDeviceRequest\032\033.google.cloud.iot.v1.Device\"\214\001\202\323\344\223\002\177\0228/v1/{name=projects/*/locations/*/registries/*/devices/*}ZC\022A/v1/{name=projects/*/locations/*/registries/*/groups/*/devices/*}\332A\004name\022\221\002\n"
          + "\014UpdateDevice\022(.google.cloud.iot.v1.Upda"
          + "teDeviceRequest\032\033.google.cloud.iot.v1.Device\"\271\001\202\323\344\223\002\235\0012?/v1/{device.name=projects/*/locations/*/registries/*/devices/*}:\006deviceZR2H/v1/{device.name=projects/*/locations/*/registries/*/groups/*/devices/*}:\006device\332A\022device,update_mask\022\231\001\n"
          + "\014DeleteDevice\022(.google.cloud.iot.v1.DeleteDeviceRequest\032\026.google.protobuf.Empty\"G\202\323\344\223\002:*8/v1/{name=projects/*/locations/*/registries/*/devices/*}\332A\004name\022\361\001\n"
          + "\013ListDevices\022\'.google.cloud.iot.v1.ListDevicesRe"
          + "quest\032(.google.cloud.iot.v1.ListDevicesResponse\"\216\001\202\323\344\223\002\177\0228/v1/{parent=projects/*/locations/*/registries/*}/devicesZC\022A/v1/{parent=projects/*/locations/*/registries/*/groups/*}/devices\332A\006parent\022\313\002\n"
          + "\031ModifyCloudToDeviceConfig\0225.google.cloud.io"
          + "t.v1.ModifyCloudToDeviceConfigRequest\032!."
          + "google.cloud.iot.v1.DeviceConfig\"\323\001\202\323\344\223\002"
          + "\271\001\"R/v1/{name=projects/*/locations/*/registries/*/devices/*}:modifyCloudToDeviceConfig:\001*Z`\"[/v1/{name=projects/*/locations/*/registries/*/groups/*/devices/*}:modifyCloudToDeviceConfig:\001*\332A\020name,binary_data\022\265\002\n"
          + "\030ListDeviceConfigVersions\0224.google.cloud.iot.v1.ListDeviceConfigVersio"
          + "nsRequest\0325.google.cloud.iot.v1.ListDevi"
          + "ceConfigVersionsResponse\"\253\001\202\323\344\223\002\235\001\022G/v1/{name=projects/*/locations/*/registries/*/devices/*}/configVersionsZR\022P/v1/{name=projects/*/locations/*/registries/*/groups/*/devices/*}/configVersions\332A\004name\022\215\002\n"
          + "\020ListDeviceStates\022,.google.cloud.iot.v"
          + "1.ListDeviceStatesRequest\032-.google.cloud"
          + ".iot.v1.ListDeviceStatesResponse\"\233\001\202\323\344\223\002\215\001\022?/v1/{name=projects/*/locations/*/registries/*/devices/*}/statesZJ\022H/v1/{name=projects/*/locations/*/registries/*/groups/*/devices/*}/states\332A\004name\022\370\001\n"
          + "\014SetIamPolicy\022\".google.iam.v1.SetIamPolicyRequ"
          + "est\032\025.google.iam.v1.Policy\"\254\001\202\323\344\223\002\223\001\"?/v1/{resource=projects/*/locations/*/registries/*}:setIamPolicy:\001*ZM\"H/v1/{resource=projects/*/locations/*/registries/*/groups/*}:setIamPolicy:\001*\332A\017resource,policy\022\361\001\n"
          + "\014GetIamPolicy\022\".google.iam.v1.GetIa"
          + "mPolicyRequest\032\025.google.iam.v1.Policy\"\245\001\202\323\344\223\002\223\001\"?/v1/{resource=projects/*/locations/*/registries/*}:getIamPolicy:\001*ZM\"H/v1/{resource=projects/*/locations/*/registries/*/groups/*}:getIamPolicy:\001*\332A\010resource\022\251\002\n"
          + "\022TestIamPermissions\022(.google.iam.v1.TestIamPermissionsRequest\032).google."
          + "iam.v1.TestIamPermissionsResponse\"\275\001\202\323\344\223\002\237\001\"E/v1/{resource=projects/*/locations/*/registries/*}:testIamPermissions:\001*ZS\"N/v1/{resource=projects/*/locations/*/registries/*/groups/*}:testIamPermissions:\001*\332A\024resource,permissions\022\337\002\n"
          + "\023SendCommandToDevice\022/.google.cloud.iot.v1.SendComm"
          + "andToDeviceRequest\0320.google.cloud.iot.v1"
          + ".SendCommandToDeviceResponse\"\344\001\202\323\344\223\002\255\001\"L/v1/{name=projects/*/locations/*/registries/*/devices/*}:sendCommandToDevice:\001*ZZ\"U/v1/{name=projects/*/locations/*/registries/*/groups/*/devices/*}:sendCommandToDevice:\001*\332A\020name,binary_data\332A\032name,binary_data,subfolder\022\275\002\n"
          + "\023BindDeviceToGateway\022/.google.cloud.iot.v1.BindDeviceToGa"
          + "tewayRequest\0320.google.cloud.iot.v1.BindD"
          + "eviceToGatewayResponse\"\302\001\202\323\344\223\002\235\001\"D/v1/{parent=projects/*/locations/*/registries/*}:bindDeviceToGateway:\001*ZR\"M/v1/{parent=projects/*/locations/*/registries/*/groups/*}:bindDeviceToGateway:\001*\332A\033parent,gateway_id,device_id\022\321\002\n"
          + "\027UnbindDeviceFromGateway\0223.google.cloud.iot.v1.UnbindDevi"
          ...
          + "/registries/*}:unbindDeviceFromGateway:\001*ZV\"Q/v1/{parent=projects/*/locations/*/"
          + "registries/*/groups/*}:unbindDeviceFromGateway:\001*\332A\033parent,gateway_id,device_id\032t\312A\027cloudiot.googleapis.com\322AWhttps://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/cloudiotBj\n"
