...
private static final long serialVersionUID = 0L;
    ...
    }
    {
      ...
      for (int i = 0; i < deviceNumIds_.size(); i++) {
        dataSize += com.google.protobuf.CodedOutputStream
          .computeUInt64SizeNoTag(deviceNumIds_.getLong(i));
      }
      size += dataSize;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!getDeviceNumIdsList()
        .equals(other.getDeviceNumIdsList())) return false;
    if (!getDeviceIdsList()
    ...
    if (hasGatewayListOptions()) {
      if (!getGatewayListOptions()
          .equals(other.getGatewayListOptions())) return false;
    }
    if (getPageSize()
  ...
  checkByteStringIsUtf8(value);
    ...
    public java.util.List<java.lang.Long>
      ...
      return ((bitField0_ & 0x00000001) != 0) ?
               java.util.Collections.unmodifiableList(deviceNumIds_) : deviceNumIds_;
    }
    /**
     * <pre>
     * A list of device numeric IDs. If empty, this field is ignored. Maximum
